/**
 * Modern HatColor component using React.createContext() Selector
 */
...
export default function HatColor({ maskID }: Props) {
  return (
    <Selector option={HatColorOption} defaultOption={Blue01}>
      <Black maskID={maskID} />
